    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-[10px] font-medium tracking-[0.28em] uppercase text-gold font-jost">
        ...
        {/* Title */}
        <motion.h1
          className="font-cormorant font-extralight text-[clamp(3.2rem,9vw,6rem)] leading-[0.9] tracking-[-0.02em] text-ivory mb-7"
          variants={itemVariants}
        >
          {title}
        </motion.h1>
        ...
        {/* Subtitle */}
        <motion.p
          className="font-cormorant font-light italic text-[1.15rem] leading-[1.8] text-ivory/50 max-w-xl mx-auto mb-12 tracking-[0.01em]"
          variants={itemVariants}
        >
        ...
        >
          <Link
            ...
            className="
              ...
              text-[10px] font-bold uppercase tracking-[0.25em] font-jost
      ...
      >
        <span className="text-[8px] font-medium tracking-[0.25em] uppercase text-ivory/30 font-jost">
          Cuộn xuống
        </span>
