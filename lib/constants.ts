...
export const STUDIO_NAME =
  process.env.NEXT_PUBLIC_STUDIO_NAME ?? "Harmony Studio";
...
export const ADDRESS_STREET =
  process.env.NEXT_PUBLIC_ADDRESS_STREET ?? "45 Đường Cuối Chợ Đông Hoà";
export const ADDRESS_LOCALITY =
  process.env.NEXT_PUBLIC_ADDRESS_LOCALITY ?? "Trảng Bom";
export const ADDRESS_REGION =
  process.env.NEXT_PUBLIC_ADDRESS_REGION ?? "Đồng Nai";
