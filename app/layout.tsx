...
export const metadata: Metadata = {
  ...
  description:
    "Dịch vụ nhiếp ảnh và quay phim cưới chuyên nghiệp. Lưu giữ những khoảnh khắc hạnh phúc bằng phong cách phóng sự, ánh sáng tự nhiên và những thước phim điện ảnh.",
  keywords: [
    "chụp ảnh cưới",
    "quay phim cưới",
    "phóng sự cưới",
...
export default function RootLayout({
  ...
  return (
    <html lang="vi" className={cn(roboto.variable, "font-sans")}>
      <body className="bg-luxury text-obsidian antialiased selection:bg-obsidian-dim selection:text-obsidian">
        <TooltipProvider>
