...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const portfolios = db.prepare(
    `SELECT slug, updated_at FROM portfolios`
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/services/photography`,    priority: 0.8, changeFrequency: 'monthly' },
    { url: `${base}/services/videography`,    priority: 0.8, changeFrequency: 'monthly' },
    { url: `${base}/services/wedding-film`,   priority: 0.8, changeFrequency: 'monthly' },
