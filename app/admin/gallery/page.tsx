        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
          {items.map((item) => (
            ...
            >
              ...
              {/* Label + actions */}
              <div className="absolute bottom-0 left-0 right-0 p-3 z-20 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                {item.label && (
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Link
                    ...
                    className="flex items-center justify-center size-7 bg-white/20 hover:bg-gold transition-colors duration-300 backdrop-blur-sm"
                  >
