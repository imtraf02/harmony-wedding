        ...
        <div className="grid 3xl:grid-cols-5 grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          {items.map((item) => (
            ...
            >
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 z-10 bg-gradient-to-t from-obsidian/80 via-obsidian/30 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
